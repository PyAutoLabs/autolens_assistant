...
**Summary:** Methodology paper for flux-ratio-based DM inference.
...
**Concepts:** [[flux-ratio-anomalies]],
[[dark-matter-physics]]
**Summary:** Forward-model Bayesian pipeline using flux ratios to
constrain DM nature.
...
**Concepts:** [[flux-ratio-anomalies]]
**Summary:** Quantitative constraints on WDM from sample.

## Gilman 2019 — low-mass haloes

**File:** `Strong_Lens/Gilman2019LowMass.pdf`
**Concepts:** [[flux-ratio-anomalies]]
**Summary:** Sensitivity of flux ratios to low-mass halo
populations.
...
**Concepts:** [[flux-ratio-anomalies]]
**Summary:** Luminous (galaxy-hosting) subhaloes as perturbers.

## Hsueh 2016 — disk substructure

**File:** `Strong_Lens/Huseh2016_DiskSubstruct2.pdf`
**Concepts:** [[flux-ratio-anomalies]]
**Summary:** Baryonic disks in lens galaxies generate flux
