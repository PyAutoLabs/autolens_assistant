...
| Check 4 — bootstrap from an empty directory (Claude Code, Codex) | n/a | see `benchmarks/runs/bootstrap-smoke/` | Added 2026-09-26 (#138). Pre-merge runs substitute the branch tree URL for the repository URL; the definitive runs repeat it with the real prompt after merge. |
